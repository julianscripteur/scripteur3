...
local Window  = Library.CreateLib("Script Made By Julian54701", "BloodTheme")
...
Section:NewToggle("Auto Dupe Pop It Rainbow!, "dupe Pop It Rainbow!", function(state)
    if state then
_G.on = true
...
local Section = Tab:NewSection("Made By julian54701")
local Section = Tab:NewSection("ADD ME ON DISCORD https://discord.gg/NO")
